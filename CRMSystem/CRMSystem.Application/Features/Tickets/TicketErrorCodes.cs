...
public static class TicketErrorCodes
{
    ...
    public const string UnauthorizedAction = "ticket.unauthorized_action";
    public const string ActorNotFound = "actor.not_found";
    public const string ForbiddenAssignToOther = "forbidden_assign_to_other";
    public const string ClientNotFoundForActor = "client.not_found_for_actor";
}